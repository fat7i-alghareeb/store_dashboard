...
class _Initial<T> implements BlocStatus<T> {
  const _Initial();
...
class _Loading<T> implements BlocStatus<T> {
  const _Loading();
...
class _Success<T> implements BlocStatus<T> {
...
class _Failure<T> implements BlocStatus<T> {
...
@override
String toString() {
  return 'BlocStatus<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $BlocStatusCopyWith<T, $Res> {
